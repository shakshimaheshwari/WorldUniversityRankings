...
public class qualityofeducation{
...
public static class MapClass extends Mapper<LongWritable,Text,Text,Text> {
        public void map(LongWritable key, Text value,Context context) throws IOException, InterruptedException {
		    ...
		    String quality_of_education = tokens[4];
		    if(tokens[1].equals("institution") || tokens[4].equals("quality_of_education")|| tokens[13].equals("year"))
				return;
			...
			{
				if(quality_of_education.equals(""))
				{
				   innerMap.put(year,0);
				}
				else{
					Integer quality = Integer.parseInt(quality_of_education.trim());
    ...
    job.setJarByClass(qualityofeducation.class);
